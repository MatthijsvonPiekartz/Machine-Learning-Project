# Matthijs von Piekartz SKEPP 03-04-2019
...
# K Nearest Neighbors toepassen op de dataset
from sklearn.neighbors import KNeighborsClassifier
classifier = KNeighborsClassifier(n_neighbors = 5, metric = 'minkowski', p = 2)
classifier.fit(X_train, y_train)

# Resultates voorspellen
...
# Training set resultaten weergeven in een grafiek
